  ...
  return (
    <div className="w-full flex flex-col items-center gap-2 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="leading-2 flex flex-col gap-4 justify-center items-center ">
          ...
          <p className="font-medium font-lato text-[1.5em]">Watch anywhere. Cancel anytime.</p>
          <p className="font-medium font-lato text-[1.5em]">Ready to watch? Enter your email to create or restart your membership.</p>
        </div>
